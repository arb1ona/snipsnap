  ...
  return (
    <div className="flex gap-2 items-center">
      <div className={`bg-mainColor p-[6px] rounded-md`}>
        <DataObjectIcon sx={{ fontSize: 30, color: "white" }} />
      </div>
      <div className="flex gap-1 text-[19px]">
        <span className={`font-bold text-mainColor`}>Snip</span>
        <span className="text-slate-600">Snap</span>
      </div>
    </div>
  );
}
...
function CTASection() {
  return (
    <div className="flex flex-col mx-16 items-center mt-[120px] gap-6">
      ...
      <button
        className={`block px-9 py-3 text-sm font-medium text-mainColor transition focus:outline-none`}
        type="button"
      >
        Let's get started!
      </button>
