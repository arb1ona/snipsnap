...
function AllNotesSection() {
  ...
  return (
    <div
      className={`mt-5 ${
        isMobile || openContentNote ? "grid grid-cols-1" : "flex flex-wrap"
      }  gap-6  `}
    >
...
function SingleNote({ note }: { note: SingleNoteType }) {
  ...
  return (
    <div
      ...
      } ${openContentNote ? "w-full" : "w-[390px]"} 
      max-sm:w-full rounded-md py-4   hover:translate-y-[-1px] ${
        selectedNote?._id === _id && !selectedNote.isTrash
    ...
    <div className=" flex justify-between   text-[13px] text-slate-400 mx-4 mt-3">
      ...
      <div className="flex gap-2 items-center">
        ...
        <DeleteRoundedIcon
          ...
          sx={{ fontSize: 17 }}
          className={`cursor-pointer ${note.isTrash && "text-purple-600"} ${
